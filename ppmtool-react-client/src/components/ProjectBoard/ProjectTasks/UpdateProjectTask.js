...
class UpdateProjectTask extends Component {
    ...
    static getDerivedStateFromProps(nextProps, prevState) {
        ...
        // project_task
        if(prevState.id != nextProps.project_task.id 
    ...
    onSubmit = (e) => {
        ...
        this.props.updateProjectTask(this.state.projectIdentifier, updatedTask, this.props.history)
    }
